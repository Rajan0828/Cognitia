...
const Button = ({ children, onClick, disabled = false, className = '', variant = 'primary', type = 'button', size = 'md' }) => {
  const baseStyles =
    'inline-flex items-center justify-center gap-2 rounded-xl font-semibold transition-all duration-200 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 disabled:active:scale-100 whitespace-nowrap';
