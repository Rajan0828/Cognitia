  ...
  return (
    <div className="flex min-h-[40vh] items-center justify-center p-8">
      <div className="relative flex flex-col items-center gap-4">
        ...
        <div className="relative flex h-20 w-20 items-center justify-center rounded-[1.75rem] border border-emerald-100 bg-white/80 shadow-lg shadow-emerald-500/10 backdrop-blur-xl">
