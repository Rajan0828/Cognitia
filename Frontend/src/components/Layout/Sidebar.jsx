...
import { LayoutDashboard, User, LogOut, FileText, BrainCircuit, BookOpen, X } from 'lucide-react';
      ...
      >
        ...
        <div className='flex items-center justify-between h-16 px-5 border-b border-slate-200/60'>
          <div className='flex items-center gap-3'>
            <div className='flex items-center justify-center w-9 h-9 rounded-xl bg-linear-to-br from-emerald-400 to-teal-500 shadow-emerald-500/20'>
              <BrainCircuit
            ...
            <h1 className='text-sm md:text-base font-bold text-slate-900 tracking-tight'>Cognitia</h1>
          </div>
          <button
            onClick={toggleSidebar}
        ...
        <div className='px-3 py-4 border-t border-slate-200/60'>
          <button
            ...
            className='group flex items-center gap-3 w-full px-4 py-2.5 text-sm rounded-xl text-slate-700 hover:bg-red-50 hover:text-red-600 transition-all duration-200'
          >
            <LogOut
              size={18}
              strokeWidth={2.5}
