  ...
  return (
    <div className='min-h-screen'>
      ...
      <div className='relative max-w-7xl mx-auto'>
        {/* HEADER */}
        <div className='mb-6'>
          <h1 className='text-xl font-medium text-slate-900 tracking-tight mb-2'>Dashboard</h1>
        ...
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6'>
          ...
          (dashboardData.recentActivity.documents.length > 0 || dashboardData.recentActivity.quizzes.length > 0) ? (
                    ...
                    <div className='flex-1 min-w-0'>
                      <div className='flex items-center gap-2 mb-1'>
                        ...
                        <p className='text-sm font-medium text-slate-900 truncate'>
                          {activity.type === 'document' ? 'Accessed Document: ' : 'Attempted Quizzes: '}
            ...
            <div className='text-center py-12'>
              ...
              <p className='text-xs text-slate-500 mt-1'>Start learning to track your progress!</p>
            </div>
          )}
        </div>
      </div>
